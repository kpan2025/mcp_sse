defmodule MCPServerTest do
  ...
  defmodule MockServer do
    ...
    @impl true
    def handle_ping(_session_id, request_id) do
    ...
    @impl true
    def handle_read_resource(_session_id, request_id, _params) do
    ...
    @impl true
    def handle_call_tool(_session_id, request_id, _params) do
  ...
  describe "MCPServer behaviour" do
    test "handle_ping implementation" do
      ...
      assert {:ok, response} = MockServer.handle_ping(session_id, request_id)
    ...
    test "handle_initialize implementation" do
      ...
      assert {:ok, response} = MockServer.handle_initialize(session_id, request_id, params)
    ...
    test "optional callback handle_complete" do
      ...
      assert {:ok, response} = MockServer.handle_complete(session_id, request_id, params)
